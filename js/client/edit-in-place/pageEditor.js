...
var uPageEditor = function () {
	...
	this.disable = function () {
		...
		jQuery(document).unbind('keydown', self.bindHotkeys);
	};
...
//			jQuery(document).unbind('click');
	...
	this.bindHotkeys = function(e) {
			if(e.ctrlKey) {
				switch(e.keyCode) {
				case 83: self.submit(); break; // Ctrl + S
				case 90: self.back(1); break; // Ctrl + Z
				case 89: self.forward(1); break; // Ctrl + Y
					default: return true;
				}
				return false;
			}
